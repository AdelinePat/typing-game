...
def draw_game():
    ...
    main_menu_button = Button(700, 150, 'Menu Principal', 1, screen.screen.get_rect().center)
...
def draw_menu():
    ...
    game_menu_button = Button(450, 100, "Jouer", 1, ((screen.width // 2), (screen.height // 8)))
    mode_menu_button = Button(450, 100, "Mode", 1, ((screen.width // 2), (screen.height // 8) + (screen.height //4)))
    score_menu_button = Button(450, 100, "Score", 1, ((screen.width // 2), (screen.height // 8) + (screen.height //4)*2))
    exit_menu_button = Button(450, 100, "Quitter", 1, ((screen.width // 2), (screen.height // 8) + (screen.height //4)*3))
