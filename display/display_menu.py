...
def get_main_menu_button(translator):   
    ...
    main_menu_button = Button_image(700, 150, main_menu_text, "main_menu",\
                        BUTTON_IMAGE, SCREEN.screen, SCREEN.screen.get_rect().center)
...
def get_buttons(translator):
    ...
    game_menu_button = Button_image(450, 100, game_menu_text, "game_on",\
            BUTTON_IMAGE, SCREEN.screen, ((SCREEN.width // 2), (SCREEN.height // 8)))
    
    mode_menu_button = Button_image(450, 100, mode_menu_text, "mode_menu",\
            BUTTON_IMAGE2, SCREEN.screen, ((SCREEN.width // 2), (SCREEN.height // 8) + (SCREEN.height //4)))
    
    score_menu_button = Button_image(450, 100, score_menu_text, "score_menu",\
            BUTTON_IMAGE3, SCREEN.screen, ((SCREEN.width // 2), (SCREEN.height // 8) + (SCREEN.height //4)*2))
    
    exit_menu_button = Button_image(450, 100, exit_menu_text, "exit_menu",\
            BUTTON_IMAGE4, SCREEN.screen, ((SCREEN.width // 2), (SCREEN.height // 8) + (SCREEN.height //4)*3))
...
def create_mode_menu_button(translator):
    ...
    in_menu_button = Button_image(450, 100, mode, "mode_menu",\
                    BUTTON_IMAGE2, SCREEN.screen, ((SCREEN.width // 2), 70))
    
    difficulty_button = Button_image(300, 70, difficulty, "mode_menu",\
                    BUTTON_IMAGE, SCREEN.screen, ((SCREEN.width // 4), (SCREEN.height // 2 - 100)))
    
    language_button = Button_image(300, 70, language, "mode_menu",\
                    BUTTON_IMAGE3, SCREEN.screen, ((SCREEN.width // 4)*3, (SCREEN.height // 2 - 100)))
...
def get_difficulty_buttons(translator):
    ...
    easy_difficulty_button = Button(easy, "easy_mode", 28, MAIN_FONT,\
                            SCREEN.screen, ((SCREEN.width // 4), (SCREEN.height // 2 - 10)))
    
    normal_difficulty_button = Button(normal, "normal_mode", 28, MAIN_FONT,\
                            SCREEN.screen, (SCREEN.width // 4, SCREEN.height // 2 + 70))
    
    nightmare_difficulty_button = Button(difficult, "nightmare_mode", 28,\
                            MAIN_FONT, SCREEN.screen, (SCREEN.width // 4, SCREEN.height // 2 + 150))
...
def get_language_buttons(translator):
    ...
    french_button = Button(french, "fr", 28, MAIN_FONT, SCREEN.screen,\
                    ((SCREEN.width // 4)*3, SCREEN.height // 2 - 10))
    
    english_button = Button(english, "eng", 28, MAIN_FONT,\
                    SCREEN.screen, ((SCREEN.width // 4)*3, SCREEN.height // 2 + 70))
...
def game_over_screen(player_score, translator):
    ...
    message_button = Button(game_over_dialog, "game_over_message", 42,\
                    MAIN_FONT, SCREEN.screen, (SCREEN.width//2, SCREEN.height//2 - SCREEN.height // 4.5))
    
    message_button.draw(TEXT_COLOR_LIGHT)

    game_over_button = Button_image(600, 150, game_over_button_message,\
                    "game_over_button", BUTTON_IMAGE4, SCREEN.screen, (SCREEN.width //2, SCREEN.height // 2))
    
    game_over_button.draw(TEXT_COLOR_DARK)

    info_dialog_button = Button(info_dialog, "info_dialog_game_over",\
                    30, MAIN_FONT, SCREEN.screen, (SCREEN.width//2, SCREEN.height//2 + SCREEN.height // 4.5))
